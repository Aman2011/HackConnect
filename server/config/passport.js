        ...
        process.nextTick(function () {
            User.findOne({'linkedIn.id': profile.id}, function (err, user) {
                ...
                if(user) {
                    ...
                    var position = profileJson.positions.values.length > 0 ? profileJson.positions.values[0]:false;
                    var picture = profileJson.pictureUrls.values.length > 0 ? profileJson.pictureUrls.values[0]:false;
                    ...
                    newUser.profile.picture = picture?picture:"";
